        ...
        for (let r = hr + 1; r < js.length; r++) {
            ...
            for (const ci in dc) {
                ...
                let m; while ((m = rg.exec(val)) !== null) {
                    ...
                    // 简单的性别判断：根据常见女性名字特征
                    let gender = 'M'; // 默认男生
                    let femaleChars = ['婷', '娜', '丽', '美', '芳', '燕', '莉', '娟', '琳', '静', '敏', '慧', '雪', '梅', '玲', '嫣', '妍', '媛', '萍', '红', '霞', '艳', '秀', '英', '兰', '凤', '云', '珍', '月', '春', '菊', '华', '蓉', '琴', '瑶', '薇', '茜', '倩', '欣', '怡', '彤', '馨', '雅', '洁', '颖', '娇', '婉', '柔', '芬', '晴', '露', '冰', '诗', '曼', '佳', '思', '涵', '悦', '莹', '璐', '瑾', '珊', '岚', '蕾', '菲', '婕', '琪', '韵', '茹', '苑', '荷', '兰', '芝', '蝶', '翠', '碧', '素', '纯', '真', '淑', '贤', '惠', '爱', '宜', '依', '若', '如', '梦', '舒', '婧', '娅', '姗', '姝', '娴', '嫦', '姬', '妮', '妙', '姣', '娥', '姿', '妃', '姞', '姮', '姯', '姱', '姳', '姵', '姶', '姷', '姸', '姹', '姺', '姻', '姼', '姽', '姾', '姿', '娀', '威', '娂', '娃', '娄', '娅', '娆', '娇', '娈', '娉', '娊', '娋', '娌', '娍', '娎', '娏', '娐', '娑', '娒', '娓', '娔', '娕', '娖', '娗', '娘', '娙', '娚', '娛', '娜', '娝', '娞', '娟', '娠', '娡', '娢', '娣', '娤', '娥', '娦', '娧', '娨', '娩', '娪', '娫', '娬', '娭', '娮', '娯', '娰', '娱', '娲', '娳', '娴', '娵', '娶', '娷', '娸', '娹', '娺', '娻', '娼', '娽', '娾', '娿', '婀', '婁', '婂', '婃', '婄', '婅', '婆', '婇', '婈', '婉', '婊', '婋', '婌', '婍', '婎', '婏', '婐', '婑', '婒', '婓', '婔', '婕', '婖', '婗', '婘', '婙', '婚', '婛', '婜', '婝', '婞', '婟', '婠', '婡', '婢', '婣', '婤', '婥', '婦', '婧', '婨', '婩', '婪', '婫', '婬', '婭', '婮', '婯', '婰', '婱', '婲', '婳', '婴', '婵', '婶', '婷', '婸', '婹', '婺', '婻', '婼', '婽', '婾', '婿'];
                    if (femaleChars.some(char => name.includes(char))) {
                        gender = 'F';
                    }
                    addStudent(name, gender, [`${dk}-${sk}${weekStr}`]);
                }
            }
        }
        closeImport(); 
        toast('解析Excel完毕，请检查学生性别是否正确（点击学生列表中的性别按钮可修改）', 'success');
    };
